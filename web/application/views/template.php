			...
			<div class="container">
				...
				<div class="navbar-header">
					<!--<div class="row">-->
						...
						<div class="col-xs-12 col-sm-6 col-md-3">
							<a href="#recall" class="recall-button fancybox"><span class="glyphicon glyphicon-wrench" aria-hidden="true"></span> Вызвать&nbsp;мастера</a>
						</div>
					<!--</div>-->
				</div>
			</div>
			<div class="background-belize-hole color-white">
				<div class="container">
